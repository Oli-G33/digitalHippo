...
var yourOwnAndPurchase = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
                ...
                purchasedProductFileIds = orders
                    ...
                    return order.products.map(function (product) {
                        if (typeof product === 'string')
                            return req.payload.logger.error('Search depth not sufficient to find purchase filed IDs');
